...
function SearchBar({searchMovie, setSearchMovie, fetchMovieData}) {
  return (
    <div className='mainn flex justify-center py-5 px-4'>
        <input type="text"
        placeholder='Search'
        value={searchMovie}
        //onChange={()}
        ...
        className='bg-[#40407a] shadow-md px-4 text-white rounded-r-lg border-b-2 border-t-2 border-r-2 border-gray-500'>Search</button>
